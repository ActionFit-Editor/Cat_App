...
- Keep `LavaRushProfileRosterBase`, `LavaRushAudioBase`, semantic localization keys, and `LavaRushAnalyticsSinkBase` reusable-facing; Cat selection, routing, and mapping policy belongs in this product package.
